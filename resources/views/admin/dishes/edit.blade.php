        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.menu.update', ['dish' => $dish->slug]) }}"
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="description" type="text" class="form-control @error('description') is-invalid @enderror" rows="10"
                                ...
                                <div class="col-md-6 offset-md-4">
                                    <div class="d-flex gap-2">
                                        <button type="submit" class="btn btn-secondary">
                                            <a href="{{ route('admin.menu.show', $dish->slug) }}">
                                                {{ __('Indietro') }}
                                            </a>
                                        </button>
